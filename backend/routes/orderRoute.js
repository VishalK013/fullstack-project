...
const { placeorder, getAllOrder, getUsersOrder, getUserOrderCount, getAllOrderCount, updateOrderStatus, cancleOrder } = require("../controllers/orderController")
const { verifyToken, verifyAdmin } = require("../middleware/authMiddleware")

const router = express.Router();

router.post('/place-order', verifyToken, placeorder);
router.post("/cancel/:id", verifyToken, cancleOrder)
